...
Environment: Python 3.12.14, numpy 2.5.2, scipy 1.18.0, Linux-7.2.5-3-omarchy-x86_64-with-glibc2.44, 12 CPUs, commit f64441d, 2026-09-21 15:29:58 MDT.  Runtime 1146 s.  Nothing in this gate touches a QPU.
...
(pinned with --shots-by-rep allocation, 13692 shots in total, 987 s; the pilot measured
0.033 s/shot at r=1, 0.064 s/shot at r=2, 0.094 s/shot at r=3,
i.e. 5.4 s per shot over the whole set, and the budget was 14 min).
