...
**Status: PASS** — `scripts/laptop_L5_cudaq_check.py`, target qpp-cpu.  Environment: Python 3.12.14, numpy 2.5.2, scipy 1.18.0, Linux-7.2.3-arch1-3-x86_64-with-glibc2.44, 12 CPUs, commit 41b83c1, 2026-09-14 17:39:31 MDT.
Runtime 4 s; sampling 10000 shots took 1.27 s.  Conventions found: result strings list
...
| total-variation distance to the exact distribution | 0.017 | < 0.272 | PASS |
